...
namespace Graphium.ViewModels
{
    internal class MainWindowViewModel : BaseViewModel
    {
        ...
        public string GraphCount => $"{BiologicalSignals.Count} / {MaxChannels}";
        #endregion
        #region RELAY_COMMANDS
        public RelayCommand StartCapCommand => new RelayCommand(execute => StartCapturing() , canExecute => BiologicalSignals.Count > 0); 
        public RelayCommand AddBSCommand => new RelayCommand(execute => AddBiologicalSignal() , canExecute => BiologicalSignals.Count < MaxChannels );
