...
namespace Graphium.Behaviors
{
    ...
    {
        public ObservableCollection<SignalVisualizerViewModel> Visualizers
        {
            get => (ObservableCollection<SignalVisualizerViewModel>)GetValue(VisualizersProperty);
        ...
        public static readonly DependencyProperty VisualizersProperty =
            DependencyProperty.Register(
                nameof(Visualizers),
                typeof(ObservableCollection<SignalVisualizerViewModel>),
        ...
        private static void OnVisualizersChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.OldValue is ObservableCollection<SignalVisualizerViewModel> oldCol)
                oldCol.CollectionChanged -= behavior.OnCollectionChanged;

            if (e.NewValue is ObservableCollection<SignalVisualizerViewModel> newCol)
